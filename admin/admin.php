                    ...
                    <div class="card">
                      ...
                      while($data = mysqli_fetch_assoc($res)){
                        ...
                        ?>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-warning" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalEdit<?= $id_admin; ?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalDelete<?= $id_admin; ?>">
                                                    Delete
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- Modal edit-->
                                    <div class="modal fade" id="exampleModalEdit<?= $id_admin; ?>" tabindex="-1"
                                    ...
                                    <!-- Modal Delete -->
                                    <div class="modal fade" id="exampleModalDelete<?= $id_admin; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">

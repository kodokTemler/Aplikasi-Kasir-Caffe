...
if (isset($_POST["masuk"])) {
    ...
    $query = "SELECT * FROM tb_superadmin WHERE username = ?";
    ...
    if ($result->num_rows == 1) {
        ...
        if ($row["username"] == $username && $row["password"] == $password) {
            ...
            $login_error = "Username, password, atau peran salah.";
        }
    } else {
...
<body>
    <section>
        <div class="leaves">
            <div class="set">
                <div><img src="assets/img/leaf_01.png" /></div>
                <div><img src="assets/img/leaf_02.png" /></div>
                <div><img src="assets/img/leaf_03.png" /></div>
                <div><img src="assets/img/leaf_04.png" /></div>
                <div><img src="assets/img/leaf_01.png" /></div>
                <div><img src="assets/img/leaf_02.png" /></div>
                <div><img src="assets/img/leaf_03.png" /></div>
                <div><img src="assets/img/leaf_04.png" /></div>
        ...
        <form action="" method="post">
            <div class="login">
                <h2>Sign In</h2>
                <div class="inputBox"><input type="text" placeholder="Username" name="username">
                </div>
                <div class="inputBox">
